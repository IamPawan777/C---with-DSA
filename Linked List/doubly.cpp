...
// /*........insert mid, last (with value game)......*/
...
// // void insertAtHead(Node* &head, int data) {           //not posible
// //     Node* node = new Node(data);
// //     node->next = head;
// //     head->prev = node;
// //     head = node;
...
// void insertNode(Node* &head, Node* &tail, int key, int value) {
...
// /*......insert mid last and delete (with position game).....*/
